...
enum ExportService {
    ...
    static func export(
        ...
        let payload: [String: Any] = [
            ...
            "ideas": ideas.map { ["id": $0.id.uuidString, "title": $0.title, "content": $0.content, "tags": $0.tags, "pinned": $0.pinned, "parentId": json($0.parentID?.uuidString), "folderId": json($0.folderID?.uuidString), "canvasX": json($0.canvasX), "canvasY": json($0.canvasY), "createdAt": iso.string(from: $0.createdAt), "updatedAt": iso.string(from: $0.updatedAt)] },
